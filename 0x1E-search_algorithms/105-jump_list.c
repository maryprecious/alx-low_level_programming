 ...
 * @curr: the current node of list
 * @size: the size of list
 * @step: the jump increment
 * @val: search value
 *
...
/**
 * look_ahead - the check value at next step
 * @probe: the pointer sent out to check next step in list
 * @step: jump interval
 *
...
/**
 * subrecurse_help - the recursive implement for recursive implement
 * @curr: the current node to check
 * @step: the interval of jumps
