...
/**
 * interpolation_search - will find the value in array
...
/**
 * recurse_helper - the recursive implement
 * @array: the array to search
 * @left: the left bound of subarray
 * @right: the right bound of subarray
 * @value: search value
 *
